"""
Slash command system for EriRPG.

Simpler than SuperClaude's 30 commands, but more powerful because
they're project-aware and integrate with the workflow system.

Commands fall into three categories:
1. Workflow stages - /analyze, /discuss, /implement, /review, /debug
2. Persona overrides - /architect, /dev, /critic, /analyst, /mentor
3. Project management - /roadmap, /status, /learn, /context, /help
"""
