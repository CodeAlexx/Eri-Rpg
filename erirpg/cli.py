...
from erirpg.config import (
    load_config, save_config, get_mode, set_mode, graduate_project,
    init_project_config, ProjectConfig
)
...
# ============================================================================
# Bootstrap/Maintain Mode Commands
# ============================================================================
...
# ============================================================================
# Pattern Analysis and Implementation Commands
# ============================================================================
...
def implement(project: str, feature: str, plan_only: bool, yes: bool):
    ...
    if not patterns_path.exists():
        ...
        if click.confirm("Analyze now?"):
            from erirpg.analyze import analyze_project, save_patterns
            patterns = analyze_project(proj.path)
            save_patterns(proj.path, patterns)
        else:
            sys.exit(1)
...
def transplant(source: str, target: str, edit: bool):
    """Transplant a feature from one project to another.
    ...
    Examples:
        eri-rpg transplant --from simpletuner:training/klein.py --to onetrainer
        eri-rpg transplant --from feature.md --to myproject
    """
    from erirpg.analyze import load_patterns, get_patterns_path
    from erirpg.implement import (
...
# ============================================================================
# Persona & Context Commands (SuperClaude replacement)
# ============================================================================
